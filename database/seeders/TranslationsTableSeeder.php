...
class TranslationsTableSeeder extends Seeder
{
    ...
    private function pagesTranslations()
    {
        ...
        if ($page->exists) {
            $_arr = $this->arr(['projects', 'title'], $page->id);
             ...
             * ```
             */
            $_arr = $this->arr(['projects', 'slug'], $page->id);
            $this->trans('pt', $_arr, 'ola-mundo');

            $_arr = $this->arr(['projects', 'body'], $page->id);
    ...
    private function menusTranslations()
    {
        ...
        $_item = $this->findMenuItem(__('voyager::seeders.menu_items.projects'));
        if ($_item->exists) {
